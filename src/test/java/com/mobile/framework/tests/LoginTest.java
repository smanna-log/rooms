...
import com.mobile.framework.pages.BasePage;
...
public class LoginTest extends BaseTest {
    ...
    public void testSuccessfulLogin() {
        ...
        try {
            ...
            // Perform 3 slides (onboarding) BEFORE checking for login page visibility
            loginPage.performSlides(3);
            logger.info("Performed 3 onboarding slides");

            // Verify login page is displayed
            Assert.assertTrue(loginPage.isLoginPageDisplayed(), "Login page should be displayed after onboarding");
